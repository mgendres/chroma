...
{ 
  ...
  {
    packed_gauge = (PrimitiveSU3MatrixD *)0x0;
    init();
  }
  ...
  //  packed_gauge.resize( Nd * Layout::sitesOnNode() );
   size_t alloc_bytes=4*Layout::sitesOnNode()*sizeof(PrimitiveSU3MatrixD);
   packed_gauge = (PrimitiveSU3MatrixD *)valloc(alloc_bytes);
